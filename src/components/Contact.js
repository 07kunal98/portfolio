    ...
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <p className="leading-relaxed mb-5">
              Please mail me using this form below.
          </p>
          ...
          <button
            type="submit"
            className="hover:animate-pulse text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            Submit
          </button>
